...
QBCore.Commands.Add("addpermission", "Dar permisos de jugador (Solo Administradores)", {{name="id", help="ID of player"}, {name="permission", help="Permission level"}}, true, function(source, args)
...
QBCore.Commands.Add("gang", "Checkea tu banda", {}, false, function(source, args)
	local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Commands.Add("clearinv", "Vaciar Inventario de jugadores (Solo Administradores)", {{name="id", help="ID Jugador"}}, false, function(source, args)
