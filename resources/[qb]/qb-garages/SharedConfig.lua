Garages = {
    ...
    ["themotorhotel"] = {
        label = "Parking de el hotel de el motor",
    ...
    ["pillboxgarage"] = {
        label = "Parking de el garaje de Pillbox",
