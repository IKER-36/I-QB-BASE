...
DP.Expressions = {
   ...
   ["Sin palabras"] = {"Expression", "pose_injured_1"},
   ...
   ["Herido"] = {"Expression", "mood_injured_1"},
   ["Alegre"] = {"Expression", "mood_dancing_low_1"},
   ["Respirador"] = {"Expression", "smoking_hold_1"},
   ["Sin parpadear"] = {"Expression", "pose_normal_1"},
   ["Guiñar un ojo"] = {"Expression", "pose_aiming_1"},
   ...
   ["Extrañado"] = {"Expression", "effort_2"},
   ["Extrañodo2"] = {"Expression", "effort_3"},
}

DP.Walks = {
  ["Alien"] = {"move_m@alien"},
  ["Armado"] = {"anim_group_move_ballistic"},
  ...
  ["Sexy"] = {"move_f@sexy@a"},
  ["Sospechoso"] = {"move_m@shadyped@a"},
  ["Lento"] = {"move_characters@jimmy@slow@"},
  ["Pavonearse"] = {"move_m@swagger"},
  ["Duro"] = {"move_m@tough_guy@"},
  ["Duro2"] = {"move_f@tough_guy@"},
  ["Basurero"] = {"clipset@move@trash_fast_turn"},
  ["Basurero2"] = {"missfbi4prepp1_garbageman"},
  ["Trevor"] = {"move_p_m_two"},
  ["Fuerte"] = {"move_m@bag"},
...
DP.Shared = {
   ...
   ["hug"] = {"mp_ped_interaction", "kisses_guy_a", "Abrazar", "hug2", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
       SyncOffsetFront = 1.05,
   }},
   ["hug2"] = {"mp_ped_interaction", "kisses_guy_b", "Abrazar 2", "hug", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
   ...
   ["baseballthrow"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_b", "Lanzamiento de béisbol", "baseball"},
...
DP.Dances = {
   ...
   ["dance"] = {"anim@amb@nightclub@dancers@podium_dancers@", "hi_dance_facedj_17_v2_male^5", "Baile 1", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["danceupper"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "high_center", "Mover la manos", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["danceupper2"] = {"anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "high_center_up", "Mover la manos 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["danceglowstick"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_13_mi_hi_sexualgriding_laz", "Palos luminosos", AnimationOptions =
   {
   ...
   ["danceglowstick2"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_12_mi_hi_bootyshake_laz", "Palos luminosos 2", AnimationOptions =
   {
       Prop = 'ba_prop_battle_glowstick_01',
       PropBone = 28422,
       PropPlacement = {0.0700,0.1400,0.0,-80.0,20.0},
   ...
   ["danceglowstick3"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_09_mi_hi_bellydancer_laz", "Palos luminosos 3", AnimationOptions =
   {
       Prop = 'ba_prop_battle_glowstick_01',
       PropBone = 28422,
       PropPlacement = {0.0700,0.1400,0.0,-80.0,20.0},
...
DP.Emotes = {
   ...
   ["cloudgaze"] = {"switch@trevor@annoys_sunbathers", "trev_annoys_sunbathers_loop_girl", "Tumbarse", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["cloudgaze2"] = {"switch@trevor@annoys_sunbathers", "trev_annoys_sunbathers_loop_guy", "Tumbarse 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["pullover"] = {"misscarsteal3pullover", "pull_over_right", "Indicar", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 1300,
   }},
   ["idle"] = {"anim@heists@heist_corona@team_idles@male_a", "idle", "Holgazanear", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle8"] = {"amb@world_human_hang_out_street@male_b@idle_a", "idle_b", "Holgazanear 8"},
   ["idle9"] = {"friends@fra@ig_1", "base_idle", "Holgazanear 9", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle10"] = {"mp_move@prostitute@m@french", "idle", "Holgazanear 10", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["idle11"] = {"random@countrysiderobbery", "idle_a", "Holgazanear 11", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle2"] = {"anim@heists@heist_corona@team_idles@female_a", "idle", "Holgazanear 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle3"] = {"anim@heists@humane_labs@finale@strip_club", "ped_b_celebrate_loop", "Holgazanear 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle4"] = {"anim@mp_celebration@idles@female", "celebration_idle_f_a", "Holgazanear 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle5"] = {"anim@mp_corona_idles@female_b@idle_a", "idle_a", "Holgazanear 5", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle6"] = {"anim@mp_corona_idles@male_c@idle_a", "idle_a", "Holgazanear 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idle7"] = {"anim@mp_corona_idles@male_d@idle_a", "idle_a", "Holgazanear 7", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["idledrunk"] = {"random@drunk_driver_1", "drunk_driver_stand_loop_dd1", "Borracho parado", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idledrunk2"] = {"random@drunk_driver_1", "drunk_driver_stand_loop_dd2", "Borracho parado 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["idledrunk3"] = {"missarmenian2", "standing_idle_loop_drunk", "Borracho parado 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["airguitar"] = {"anim@mp_player_intcelebrationfemale@air_guitar", "air_guitar", "Guitarra en el aire"},
   ["airsynth"] = {"anim@mp_player_intcelebrationfemale@air_synth", "air_synth", "Piano en el aire"},
   ...
   ["blowkiss"] = {"anim@mp_player_intcelebrationfemale@blow_kiss", "blow_kiss", "Beso al aire"},
   ["blowkiss2"] = {"anim@mp_player_intselfieblow_kiss", "exit", "Beso al aire 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   ...
   ["bringiton"] = {"misscommon@response", "bring_it_on", "Bienvenido", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000
   }},
   ...
   ["crossarmsside"] = {"rcmnigel1a_band_groupies", "base_m2", "Lado de brazos cruzados", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["surrender"] = {"random@arrests@busted", "idle_a", "Rehén", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["facepalm2"] = {"anim@mp_player_intcelebrationfemale@face_palm", "face_palm", "Manos a la cara 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 8000
   }},
   ["facepalm"] = {"random@car_thief@agitated@idle_a", "agitated_idle_a", "Manos a la cara", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 8000
   }},
   ["facepalm3"] = {"missminuteman_1ig_2", "tasered_2", "Manos a la cara 3", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 8000
   }},
   ["facepalm4"] = {"anim@mp_player_intupperface_palm", "idle_a", "Manos a la cara 4", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ...
   ["fallasleep"] = {"mp_sleep", "sleep_loop", "Deprimido", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true,
   }},
   ...
   ["jog2"] = {"amb@world_human_jog_standing@male@idle_a", "idle_a", "Correr 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["jog3"] = {"amb@world_human_jog_standing@female@idle_a", "idle_a", "Correr 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["jog4"] = {"amb@world_human_power_walker@female@idle_a", "idle_a", "Correr 4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["jog5"] = {"move_m@joy@a", "walk", "Correr 5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["leanflirt"] = {"random@street_race", "_car_a_flirt_girl", "Apoyarse en la rodilla", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["leanbar2"] = {"amb@prop_human_bum_shopping_cart@male@idle_a", "idle_c", "Apoyarse a una barra 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["leanbar3"] = {"anim@amb@nightclub@lazlow@ig1_vip@", "clubvip_base_laz", "Apoyarse a una barra 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["leanbar4"] = {"anim@heists@prison_heist", "ped_b_loop_a", "Apoyarse a una barra 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["leanhigh"] = {"anim@mp_ferris_wheel", "idle_a_player_one", "Extender los brazos", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["leanhigh2"] = {"anim@mp_ferris_wheel", "idle_a_player_two", "Extender los brazos 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["nosepick"] = {"anim@mp_player_intcelebrationfemale@nose_pick", "nose_pick", "Sacarse un moco", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["pickup"] = {"random@domestic", "pickup_low", "Recoger algo del suelo"},
   ...
   ["salute"] = {"anim@mp_player_intincarsalutestd@ds@", "idle_a", "Saludo formal", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["salute2"] = {"anim@mp_player_intincarsalutestd@ps@", "idle_a", "Saludo formal 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["salute3"] = {"anim@mp_player_intuppersalute", "idle_a", "Saludo formal 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["sitlean"] = {"timetable@tracy@ig_14@", "ig_14_base_tracy", "Apoyarse sentando", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["sitchair2"] = {"timetable@ron@ig_5_p3", "ig_5_p3_base", "Sentarse en una silla 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitchair3"] = {"timetable@reunited@ig_10", "base_amanda", "Sentarse en una silla 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitchair4"] = {"timetable@ron@ig_3_couch", "base", "Sentarse en una silla 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitchair5"] = {"timetable@jimmy@mics3_ig_15@", "mics3_15_base_tracy", "Sentarse en una silla 5", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitchair6"] = {"timetable@maid@couch@", "base", "Sentarse en una silla 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitchairside"] = {"timetable@ron@ron_ig_2_alt1", "ig_2_alt1_base", "Sentarse al lado de la silla", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["wave4"] = {"random@mugging5", "001445_01_gangintimidation_1_female_idle_b", "Saludar 4", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000,
   }},
   ["wave2"] = {"anim@mp_player_intcelebrationfemale@wave", "wave", "Saludar 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave3"] = {"friends@fra@ig_1", "over_here_idle_a", "Saludar 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave"] = {"friends@frj@ig_1", "wave_a", "Saludar", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave5"] = {"friends@frj@ig_1", "wave_b", "Saludar 5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave6"] = {"friends@frj@ig_1", "wave_c", "Saludar 6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave7"] = {"friends@frj@ig_1", "wave_d", "Saludar 7", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave8"] = {"friends@frj@ig_1", "wave_e", "Saludar 8", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wave9"] = {"gestures@m@standing@casual", "gesture_hello", "Saludar 9", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["lift"] = {"random@hitch_lift", "idle_f", "Levantar pulgar", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["slide"] = {"anim@arena@celeb@flat@solo@no_props@", "slide_a_player_a", "Celebrar"},
   ["slide2"] = {"anim@arena@celeb@flat@solo@no_props@", "slide_b_player_a", "Celebrar 2"},
   ["slide3"] = {"anim@arena@celeb@flat@solo@no_props@", "slide_c_player_a", "Celebrar 3"},
   ...
   ["golfswing"] = {"rcmnigel1d", "swing_a_mark", "Jugar al golf"},
   ...
   ["tryclothes"] = {"mp_clothing@female@trousers", "try_trousers_neutral_a", "Probar ropa", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["tryclothes2"] = {"mp_clothing@female@shirt", "try_shirt_positive_a", "Probar ropa 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["tryclothes3"] = {"mp_clothing@female@shoes", "try_shoes_positive_a", "Probar ropa 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["bird"] = {"random@peyote@bird", "wakeup", "Pájaro"},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["bumbin"] = {"Scenario", "PROP_HUMAN_BUM_BIN", "Reparar"},
   ["bumsleep"] = {"Scenario", "WORLD_HUMAN_BUM_SLUMPED", "Echarse al suelo"},
   ...
   ["copbeacon"] = {"MaleScenario", "WORLD_HUMAN_CAR_PARK_ATTENDANT", "Control policial"},
   ...
   ["leanbar"] = {"Scenario", "PROP_HUMAN_BUM_SHOPPING_CART", "Apoyarse a una barra"},
   ["lookout"] = {"Scenario", "CODE_HUMAN_CROSS_ROAD_WAIT", "Estar atento"},
   ["maid"] = {"Scenario", "WORLD_HUMAN_MAID_CLEAN", "Limpiar"},
   ["medic"] = {"Scenario", "CODE_HUMAN_MEDIC_TEND_TO_DEAD", "Médico"},
   ...
   ["prosthigh"] = {"Scenario", "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", "Postura sexy"},
   ["prostlow"] = {"Scenario", "WORLD_HUMAN_PROSTITUTE_LOW_CLASS", "Postura sexy 2"},
   ["puddle"] = {"Scenario", "WORLD_HUMAN_BUM_WASH", "Limpiar"},
   ["record"] = {"Scenario", "WORLD_HUMAN_MOBILE_FILM_SHOCKING", "Grabar"},
   -- Sitchair is a litte special, since you want the player to be seated correctly.
   -- So we set it as "ScenarioObject" and do TaskStartScenarioAtPosition() instead of "AtPlace"
   ["sitchair"] = {"ScenarioObject", "PROP_HUMAN_SEAT_CHAIR_MP_PLAYER", "Sentarse en una silla"},
   ["smoke"] = {"Scenario", "WORLD_HUMAN_SMOKING", "Fumar"},
   ["smokeweed"] = {"MaleScenario", "WORLD_HUMAN_DRUG_DEALER", "Fumar hierba"},
   ["statue"] = {"Scenario", "WORLD_HUMAN_HUMAN_STATUE", "Estatua"},
   ["sunbathe3"] = {"Scenario", "WORLD_HUMAN_SUNBATHE", "Tomar el sol 3"},
   ["sunbatheback"] = {"Scenario", "WORLD_HUMAN_SUNBATHE_BACK", "Tomar el sol de espaldas"},
   ["weld"] = {"Scenario", "WORLD_HUMAN_WELDING", "Soldar"},
   ["windowshop"] = {"Scenario", "WORLD_HUMAN_WINDOW_SHOP_BROWSE", "Observar"},
   ...
   ["cutthroat"] = {"anim@mp_player_intcelebrationmale@cut_throat", "cut_throat", "Cortar el cuello"},
   ["cutthroat2"] = {"anim@mp_player_intcelebrationfemale@cut_throat", "cut_throat", "Cortar el cuello 2"},
   ...
   ["stink"] = {"anim@mp_player_intcelebrationfemale@stinker", "stinker", "Huele mal", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true
   }},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["bong"] = {"anim@safehouse@bong", "bong_stage3", "Pipa de vidrio", AnimationOptions =
   {
   ...
   ["cup"] = {"amb@world_human_drinking@coffee@male@idle_a", "idle_c", "Vaso de plastico", AnimationOptions =
   {
   ...
   ["makeitrain"] = {"anim@mp_player_intupperraining_cash", "idle_a", "Tirar billetes", AnimationOptions =
   {
   ...
   ["champagnespray"] = {"anim@mp_player_intupperspray_champagne", "idle_a", "Spray de champán", AnimationOptions =
   {
   ...
   ["joint"] = {"amb@world_human_smoking@male@male_a@enter", "enter", "Palillo de dientes", AnimationOptions =
   {
       Prop = 'p_cs_joint_02',
       PropBone = 47419,
   ...
   ["brief3"] = {"missheistdocksprep1hold_cellphone", "static", "Maletín", AnimationOptions =
   {
   ...
   ["phonecall"] = {"cellphone@", "cellphone_call_listen_base", "Llamada telefoníca", AnimationOptions =
   {
   ...
   ["clean"] = {"timetable@floyd@clean_kitchen@base", "base", "Esponja", AnimationOptions =
   {
       Prop = "prop_sponge_01",
       PropBone = 28422,
   ...
   ["clean2"] = {"amb@world_human_maid_clean@", "base", "Esponja 2", AnimationOptions =
   {
       Prop = "prop_sponge_01",
       PropBone = 28422,
       PropPlacement = {0.0, 0.0, -0.01, 90.0, 0.0, 0.0},
